...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id2=localStorage.getItem('nba-entry-2');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/nba-comment-2'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_nba_2" newsurl="/select-nba-newsDetail-2" />,
