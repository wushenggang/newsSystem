...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id2=localStorage.getItem('science-entry-2');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/science-comment-2'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_science_2" newsurl="/select-science-newsDetail-2" />,
