...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id5=localStorage.getItem('nba-entry-5');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/nba-comment-5'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_nba_5" newsurl="/select-nba-newsDetail-5" />,
