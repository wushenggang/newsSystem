...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id3=localStorage.getItem('recommend-entry-3');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/recommend-comment-3'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_recommend_3" newsurl="/select-recommend-newsDetail-3" />,
