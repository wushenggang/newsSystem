...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id3=localStorage.getItem('science-entry-3');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/science-comment-3'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_science_3" newsurl="/select-science-newsDetail-3" />,
