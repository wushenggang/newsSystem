...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id4=localStorage.getItem('nba-entry-4');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/nba-comment-4'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_nba_4" newsurl="/select-nba-newsDetail-4" />,
