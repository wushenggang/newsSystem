...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id5=localStorage.getItem('recommend-entry-5');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/recommend-comment-5'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_recommend_5" newsurl="/select-recommend-newsDetail-5" />,
