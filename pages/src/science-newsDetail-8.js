...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id8=localStorage.getItem('science-entry-8');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/science-comment-8'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_science_8" newsurl="/select-science-newsDetail-8" />,
