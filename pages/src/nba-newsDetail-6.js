...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id6=localStorage.getItem('nba-entry-6');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/nba-comment-6'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_nba_6" newsurl="/select-nba-newsDetail-6" />,
