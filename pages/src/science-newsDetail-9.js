...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id9=localStorage.getItem('science-entry-9');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/science-comment-9'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_science_9" newsurl="/select-science-newsDetail-9" />,
