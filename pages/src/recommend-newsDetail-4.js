...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id4=localStorage.getItem('recommend-entry-4');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/recommend-comment-4'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_recommend_4" newsurl="/select-recommend-newsDetail-4" />,
