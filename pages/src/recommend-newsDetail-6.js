...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id6=localStorage.getItem('recommend-entry-6');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/recommend-comment-6'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_recommend_6" newsurl="/select-recommend-newsDetail-6" />,
