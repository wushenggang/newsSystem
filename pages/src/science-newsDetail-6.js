...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id6=localStorage.getItem('science-entry-6');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/science-comment-6'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_science_6" newsurl="/select-science-newsDetail-6" />,
