...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id7=localStorage.getItem('nba-entry-7');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/nba-comment-7'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_nba_7" newsurl="/select-nba-newsDetail-7" />,
