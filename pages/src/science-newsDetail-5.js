...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id5=localStorage.getItem('science-entry-5');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/science-comment-5'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_science_5" newsurl="/select-science-newsDetail-5" />,
