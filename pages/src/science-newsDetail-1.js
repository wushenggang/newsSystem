...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id1=localStorage.getItem('science-entry-1');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/science-comment-1'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_science_1" newsurl="/select-science-newsDetail-1" />,
