...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id8=localStorage.getItem('recommend-entry-8');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/recommend-comment-8'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_recommend_8" newsurl="/select-recommend-newsDetail-8" />,
