...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id8=localStorage.getItem('nba-entry-8');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/nba-comment-8'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_nba_8" newsurl="/select-nba-newsDetail-8" />,
