...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id3=localStorage.getItem('nba-entry-3');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/nba-comment-3'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_nba_3" newsurl="/select-nba-newsDetail-3" />,
