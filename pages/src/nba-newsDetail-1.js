...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id1=localStorage.getItem('nba-entry-1');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/nba-comment-1'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_nba_1" newsurl="/select-nba-newsDetail-1" />,
