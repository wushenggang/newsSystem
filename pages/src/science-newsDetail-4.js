...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id4=localStorage.getItem('science-entry-4');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/science-comment-4'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_science_4" newsurl="/select-science-newsDetail-4" />,
