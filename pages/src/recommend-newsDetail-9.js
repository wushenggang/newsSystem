...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id9=localStorage.getItem('recommend-entry-9');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/recommend-comment-9'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_recommend_9" newsurl="/select-recommend-newsDetail-9" />,
