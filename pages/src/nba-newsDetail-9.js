...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id9=localStorage.getItem('nba-entry-9');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/nba-comment-9'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_nba_9" newsurl="/select-nba-newsDetail-9" />,
