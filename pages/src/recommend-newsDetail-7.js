...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id7=localStorage.getItem('recommend-entry-7');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/recommend-comment-7'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_recommend_7" newsurl="/select-recommend-newsDetail-7" />,
