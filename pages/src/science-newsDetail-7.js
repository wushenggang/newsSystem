...
var CommentBox=React.createClass({
    ...
    loadNewsFromServer:function(){
        var id7=localStorage.getItem('science-entry-7');
        $.ajax({
    ...
    render:function(){
        ...
        <a className="commentPage" href={'/science-comment-7'}>评论页</a>
            </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="/news_comment_science_7" newsurl="/select-science-newsDetail-7" />,
